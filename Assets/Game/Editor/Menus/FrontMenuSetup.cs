// Relabels and rebinds the ButtonRow entries in MainMenu.unity to the front menu this game has:
// Fight and Quit.
//
...
//
// Run from: Tools ▸ Eclipse ▸ Menus ▸ Setup Front Menu
...
namespace SpaceGame.EditorTools
{
    public static class FrontMenuSetup
    {
        ...
        {
            new Entry { OldMethod = "StartSinglePlayer", NewMethod = "StartGame", Label = "Fight" },
            new Entry { OldMethod = "QuitGame", NewMethod = "QuitGame", Label = "Quit" },
        };

        [MenuItem("Tools/Eclipse/Menus/Setup Front Menu")]
