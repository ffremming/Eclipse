...
namespace SpaceGame.Characters
{
    ...
    ///
    /// <para>
    /// This is a static table rather than a ScriptableObject on purpose. What is stored is an
    /// <b>index</b>, and this table is the key that decodes it — an edited palette asset would make
    /// index 3 mean a different colour than the save that wrote it meant. A static
    ...
    public static class SuitPalette
    {
        ...
        public static readonly Swatch[] Swatches =
        {
            ...
            // TheSwatchesAreTellableApart rejects, and which meant two presses of the cycler that
        ...
        public static readonly Relationship[] Relationships =
        {
            ...
            // The Nomad body the player wears now: the chosen colour is the cloak, full length
            // and shoulder flap alike — one garment, one colour. These are the ClothWind
            // materials NomadPrefabBuilder creates, matched by name like everything above.
            new("NomadCloth_Cape_01", 0f, 1f, 1f),
            new("NomadCloth_Cape_02", 0f, 1f, 1f),
        };

        public static int Count => Swatches.Length;

        /// <summary>Clamps anything — a stale save, an older build — into the list.</summary>
