...
// comes from input; everywhere else it is read back out of PlayerView.
using UnityEngine;
...
namespace SpaceGame.Characters
{
    ...
    public class PlayerAimRig : MonoBehaviour
    {
        ...
        /// <summary>
        /// Aim only while the player is actually driving their own body.
        ///
        /// <para>
        /// The same question PlayerStance.DecideStance asks, so death, cutscenes and menus all
        /// lower the weapon without any of them having to know this component exists.
        /// </para>
        /// </summary>
        ...
        ///
        /// <para>
        /// The target is anchored on <see cref="PlayerView.AimPivot"/> rather than on the camera,
        /// so the rig follows the pitch the body is actually carrying. The camera belongs to the
        /// player, not to the body, and a rig reading it would aim any other character built on
        /// this component at whatever the player happened to be looking at.
        /// </para>
        /// </summary>
