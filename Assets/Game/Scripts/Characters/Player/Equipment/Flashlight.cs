...
namespace SpaceGame.Characters
{
    ...
    public class Flashlight : MonoBehaviour
    {
        ...
        private void Update()
        {
            // Gated on scope, because this component reads the keyboard directly rather than
            // through an action map that gets switched off with the player: the same Main Camera
            // prefab that carries this light is dropped into MainMenu.unity for the backdrop, so an
            // ungated read had L switching a flashlight on behind the main menu — and behind the
            // pause menu, and on a corpse.
