...
namespace SpaceGame.Characters
{
    public class PlayerLook : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            // In children, not on the object itself: playerCamera is the eye pivot, and the camera
            // that actually renders hangs off it on the third-person boom.
            lookCamera = playerCamera != null ? playerCamera.GetComponentInChildren<Camera>(true) : null;
