...
//
// So stance is decided from input and published through the Animator, which is also what poses the
// body. One value, one direction of travel, and no second flag to keep in step with the animation.
using UnityEngine;
...
namespace SpaceGame.Characters
{
    ...
    {
        /// <summary>The bool the Crouch Tree is entered on.</summary>
