...
{
    // Free-fly camera activated when the player is eliminated and the fight carries on without
    // them. Destroyed when the player is restored or the scene unloads.
    //
