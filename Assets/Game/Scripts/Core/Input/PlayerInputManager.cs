...
namespace SpaceGame.Core
{
    ...
    public class PlayerInputManager : MonoBehaviour
    {
        ...
        /// </para>
        /// <para>
        /// Four, not ten: the hotbar is four slots wide and keys 5-10 select nothing to stow.
        /// </para>
        /// </summary>
        ...
        /// </para>
        /// <para>
        /// R is free of conflict by construction, not by luck: the action is off unless a focus
        /// session switched it on, so it does nothing in the world and nothing in a menu.
        /// </para>
        /// </summary>
