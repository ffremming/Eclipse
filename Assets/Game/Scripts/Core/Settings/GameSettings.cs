...
namespace SpaceGame.Core
{
    ...
    /// and look sensitivity arrive with the player object, and the pause menu that edits
    ...
    public static class GameSettings
    {
        ...
        /// <summary>What the game calls this player.</summary>
        ...
        private static void EnsureLoaded()
        {
            ...
            {
                // Generated once and kept, so a player who never opens the menu still has a name
                // that stays the same between runs.
