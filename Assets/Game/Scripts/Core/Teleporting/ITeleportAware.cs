...
// ─────────── how it is delivered ───────────
//
// <c>SpaceGame.Core.Teleport</c> is the single function in this project that
...
namespace SpaceGame.Teleporting
{
    public interface ITeleportAware
    {
        ...
        /// start and end are the same pose is not a teleport, and the game makes several of those
        /// a second.
        /// </summary>
