...
namespace SpaceGame.Gameplay
{
    ...
    /// them. An interact is an ACTION: Interactor is fed by PlayerInputManager, which
    /// PlayerController.DisablePlayer switches off on a body nobody is driving, so this method can
    /// only ever run for the player at the keyboard.
    ///
    /// What the triggerable does with that press is the triggerable's own business; see
