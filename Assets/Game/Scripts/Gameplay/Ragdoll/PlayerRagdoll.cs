...
namespace SpaceGame.Gameplay.Ragdoll
{
    ...
    public class PlayerRagdoll : MonoBehaviour
    {
        ...
        private void OnDeath()
        {
            ...
            // A save being restored rather than a kill. The body lies down where it is, without
            // being thrown again.
        ...
        /// <summary>
        /// A blast knocks this player off their feet.
        /// </summary>
        /// <param name="impulse">Where the blast throws them, in velocity change.</param>
        /// <param name="downSeconds">
        /// How long they stay down. Zero takes the serialized default, which is what a caller with
