...
namespace SpaceGame.Gameplay.Ragdoll
{
    ...
    ///
    /// <para>
    /// This component knows nothing about death or damage. What it knows is bones.
    ...
    public class RagdollRig : MonoBehaviour
    {
        ...
        ///
        /// Reading the hips alone was wrong: a body draped over a rock has still hips and an arm
        /// swinging free, which is not settled. The fastest bone answers the question actually
        /// being asked — has anything stopped moving yet.
        /// </summary>
        ...
        /// </param>
        public void GoLimp(Vector3 impulse, bool settled = false)
        {
            if (!built) Build();
        ...
        /// transform standing at the spot it was hit — and the transform is what the save file
        /// records, so the corpse would come back on the next load exactly where it was standing
        /// when it died.
        /// </para>
        ///
        /// <para>
