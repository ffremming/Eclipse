...
namespace SpaceGame.Locomotion
{
    public abstract partial class LeggedLocomotion
    {
        ...
        /// whole of that mode, and a snap is a write like any other. An externally posed machine is
        /// already standing wherever it was put, which is by definition on the ground it was
        /// measured against.
        ...
        /// One frame's body work for a machine that is NOT posing itself. The mirror image of
        /// AdvancePath + PoseBody:
        ...
        private void FollowBody(float dt)
        {
            ...
            // an externally written pose JUMPS — a spawn, a save restore, a teleport —
