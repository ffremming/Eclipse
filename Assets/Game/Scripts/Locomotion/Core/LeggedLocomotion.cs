...
namespace SpaceGame.Locomotion
{
    ...
    public abstract partial class LeggedLocomotion : MonoBehaviour, IExternallyPosed
    {
        [Header("Rig")]
        ...
        ///
        /// <para>
        /// Invariant I4 makes this layer the single owner of the body's transform, and while this
        /// locomotion is deciding where the machine goes it still is. When something else places
        /// the body, a locomotion that keeps writing its own answer in LateUpdate wins that
        /// argument every frame: the body stands still wherever it started.
        /// </para>
        /// <para>
        /// The legs keep solving either way — that is the whole point of following rather than
        /// switching off. Travel is measured off the body as it is placed and handed to the gait,
        /// so the feet step in time with the ground the body is genuinely covering.
        /// </para>
        /// </summary>
