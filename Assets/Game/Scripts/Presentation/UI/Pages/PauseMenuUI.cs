...
{
    /// <summary>
    /// The in-game pause screen: settings, the player's profile, and the ways out. Opened with
    ...
    /// guaranteed to be the scene the game ends up in — a scene-authored pause menu would
    ...
    public class PauseMenuUI : MonoBehaviour
    {
        ...
        /// <summary>
        /// Opens only where there is something to pause. The main menu has no player object, and a
        /// settings screen drawn over it would sit on top of a screen that already has its own
        /// navigation.
        /// </summary>
        public void Open()
        {
        ...
        public void Close()
        {
            ...
            // then hit M on is the name that ends up saved.
        ...
        /// a player destroyed. Skips handing control back, because the player it took control from
        /// no longer exists.
        /// </summary>
        ...
        private void BuildRail(RectTransform host)
        {
            ...
            var sessionRect = UIBuilder.Rect("Status", rail);
            ...
            statusLabel = UIBuilder.Label(UIBuilder.Fill(UIBuilder.Rect("Text", sessionRect), 34f, 0f, 20f, 0f),
            ...
            AddTab(tabColumn, Tab.Profile, "Profile");
        ...
        private void BuildContent(RectTransform host)
        {
            ...
            BuildProfilePage(NewPage(Tab.Profile, scrollContent));
        ...
        private void BuildProfilePage(RectTransform page)
        {
            ...
            SettingsWidgets.Caption(page, "What the game calls you. Remembered between runs.");
        }
        ...
        private void RefreshAll()
        {
            ...
            statusLabel.text = GameplayMenuScope.TimeFrozen
                ? "Simulation halted"
                : "World still running";
        }
        ...
        /// <summary>
        /// Leaving is armed by one click and committed by a second, because it abandons the fight.
        /// Cheaper than a modal, and it cannot be dismissed by accident because it disarms itself.
        /// </summary>
        private void RequestReturnToMenu()
        {
            ...
            menuButtonLabel.text = "Leave? Click again";
            menuButtonLabel.color = UITheme.AccentWarm;
        }

        /// <summary>The scene the menu button goes back to.</summary>
        ...
        private void ReturnToMenu()
        {
            ...
            UnityEngine.SceneManagement.SceneManager.LoadScene(
                MenuSceneName, UnityEngine.SceneManagement.LoadSceneMode.Single);
        }
