...
namespace SpaceGame.Presentation
{
    ...
    /// players typing into a screen that never acknowledged them.
    /// </para>
    /// </summary>
    public static class MenuField
    {
        ...
        /// value has already told us they are done, and making them find the button as well is
        /// a step for nothing.
        /// </summary>
        ...
        /// <summary>
        /// A right-aligned value drawn beside an entry's label — a count, a state, the
        /// "on" on a toggle.
        ///
