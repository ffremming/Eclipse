...
namespace SpaceGame.Weapons
{
    ...
    public abstract class Projectile : MonoBehaviour
    {
        ...
        {
            // Through Damage, so the hit registers on the server rather than only on the
            // machine that fired. GetComponentInParent is left to Damage's own lookup.
            //
            ...
            Damage.Apply(hit.collider.gameObject, damage,
        ...
        /// <para>
        /// GetComponentInParent, matching how Damage resolves its target — colliders on this
