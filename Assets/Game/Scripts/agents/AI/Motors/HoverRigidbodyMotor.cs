...
// asked for — see FlyingRigidbodyMotor.ApplyDriveInput for the long-form version of that reasoning.
using UnityEngine;
...
namespace SpaceGame.Agents
{
    ...
    public class HoverRigidbodyMotor : MonoBehaviour, IMovementMotor, IDriveableMotor
    {
        [Header("References")]
        ...
        private Vector3 DriveFromRider(in DriveInput input, float deltaTime)
        {
            currentDestination = null;
