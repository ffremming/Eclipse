...
namespace SpaceGame.Agents
{
    public class EntityFaction : MonoBehaviour
    {
        ...
        //
        // A silent null check is not good enough: the player prefab once shipped without an
        // EntityFaction, and because the targeting modules simply skipped entities that had none,
        // no AI in the arena could see the player — with no error anywhere to say so.
