...
namespace SpaceGame.Agents
{
    public class NpcItemUseModule : BehaviourModuleBase, IFacingModule
    {
        ...
        ///
        /// The target may be a player on a Rigidbody, a creature driven by a NavMeshAgent, or a
        /// vehicle — three different places to read a velocity from, and one of them is usually
        /// absent. Differencing its position is the one answer that works for all three.
        /// </summary>
        private void TrackTargetVelocity(Transform target, float deltaTime)
        {
            ...
            // Smoothed, because a single frame's difference is mostly noise, and leading a target
            // by noise is worse than not leading it at all.
